  ...
  return (
    <div className={styles.container}>
      ...
      {/* <div className={styles.card}>
        ...
        <span className={styles.important}>trustworthy</span> relationships, we
      ...
      {/* <div className={styles.card}>
        <Image
          ...
          src={servicesImage}
          alt="picture of women giving great services to a customer"
        />
        <p>
          At Gopher Courier Express, we make certain that your package gets
          safely to its destination on time. We provide courier services in
      ...
      {/* <div className={styles.card}>
        ...
        <ul>
          <li>All Day/ 1/2 Day / Expedited (2-hr.)/ Direct/Urgent service</li>
          <li>TSA certified next flight out and airport retrieval</li>
          <li>Customized routes and services to meet client needs</li>
          <li>
            Dedicated drivers for daily runs, scheduled stops, routed
      ...
      {/* <div className={styles.card}>
        ...
        <p>
          ...
          to all major industries and businesses while specializing in certain
          fields that require extra attention and dedicated support.
        </p>

        <p>
          <Link href="/">
            <a className={`${styles.card_button}`}>Gopher Courier Express</a>
          </Link>{" "}
          easily handles time-sensitive medical deliveries and materials that
          require specialized support, such as x-rays, lab samples, and
          interoffice files. We also offer bulk mail pickup and delivery. Our
          team is relied upon by a range of contractors for construction site
          deliveries, and we also serve as “mobile tellers” for many local
          banks. We do this task by picking up deposits and delivering them to
          the banks while coordinating bag exchanges. We’ll meet your needs with
          regular routed pickups or on-demand call-ins.
        </p>
      </div> */}
      ...
      {/* <div className={styles.card}>
        ...
        <Image className={styles.image} src={package_picture} alt="package" />
