  ...
  return (
    <div className={styles.container}>
      ...
      {/* <div className={cardStyles.card}>
        ...
        <p>
          Package delivery expectations these days mean prompt service and
          secure transport. Gopher Courier Express offers affordable delivery
          service in Arizona that provides our customers with peace of mind when
          they call for a pick-up. Getting your items from their source to their
          destination quickly and efficiently is our promise to our clients.
          Individuals and businesses love our professionalism and courteous
          staff, and we’re their first call when they have something that needs
          to get from point A to point B. They trust our{" "}
          <Link href="/contact">
            <a className={`${cardStyles.link}`}>courier delivery services</a>
          </Link>{" "}
          to ensure the confidentiality and safety of their documents, boxes,
          containers, and even palleted goods. Throughout the years, we’ve
          earned an exceptional reputation for superior delivery with
          unparalleled customer care. Contact our dispatch team with your
          request, and we’ll make it happen.
        </p>
      </div> */}
      ...
      {/* <div className={cardStyles.card}>
        ...
        <p>
          Price is key. Excellent service should be affordable, and our rates
          are the best in the business. Our customers rave about our
          cost-effective solutions to their courier needs. They know that when
          they need a{" "}
          <Link href="/">
            <a className={`${cardStyles.link}`}>package delivery</a>
          </Link>{" "}
          they can count on our team. Trust our clients’ recommendations for an
          affordable delivery service that will ensure your items get where they
          need to go.
        </p>
      </div> */}
